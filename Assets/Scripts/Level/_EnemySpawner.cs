...
public class _EnemySpawner : MonoBehaviour {
  ...
  void Awake() {
    ...
    meteorPool = PoolManager.CreateGameObjectPool("MeteorPool", meteorPrefabs, 20, levelEnemies);
    ufoPool = PoolManager.CreateGameObjectPool("UFOPool", ufoPrefabs, 10, levelEnemies);
  }
